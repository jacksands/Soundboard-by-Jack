...
class SoundBoard {
    ...
    /**
     * Aplica/remove loop-active no DOM e expande a categoria se necessário.
     * Funciona mesmo quando o board está fechado (idempotente).
     */
    ...
    /**
     * Varre todos os headers de categoria e atualiza o ícone de som ativo.
     */
    ...
    /**
     * Reaplica loop-active e sb-playing após o board ser renderizado/aberto.
     */
